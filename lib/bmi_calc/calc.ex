defmodule BmiCalc.Calc do
  ...
  def initial_wt_loss_goal({feet, inch}, current_wt) do
    ...
    if kgs_to_shed < 1 do
      ...
      "Shedding #{kgs_to_shed} kg over #{weeks} weeks is realistic for most people. After reaching this goal, set your next goal."
    end
  end
  ...
  def wt_loss_goal(current_wt, max_wt) when current_wt > max_wt do
    ...
    {round(kgs_to_shed), round(kgs_to_shed/0.33)}
  end
